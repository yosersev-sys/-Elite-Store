...
const CategoryPageView: React.FC<CategoryPageViewProps> = ({ 
  ...
  // تصفية المنتجات لهذا القسم حصراً
  ...
  // تحديد اللون والمظهر بناءً على نوع القسم
  const getTheme = () => {
  ...
  return (
    <div className="animate-fadeIn space-y-12 pb-20">
      ...
      <section className={`relative overflow-hidden rounded-[2.5rem] md:rounded-[3.5rem] bg-gradient-to-br ${theme.gradient} p-8 md:p-20 text-white shadow-2xl`}>
        <div className="relative z-10 space-y-4 md:space-y-6">
          ...
          <div className="flex items-center gap-4">
            <span className="text-4xl md:text-6xl">{theme.icon}</span>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm sticky top-24 z-30">
        <div className="flex items-center gap-4">
