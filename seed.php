<?php
/**
 * ملف تهيئة البيانات الشامل (Master Seed) v5.0 - سوق العصر - فاقوس
 */
...
try {
    ...
    echo json_encode(['status' => 'success', 'message' => 'تم إعادة تهيئة المتجر بـ ' . count($products) . ' منتجاً!'], JSON_UNESCAPED_UNICODE);
